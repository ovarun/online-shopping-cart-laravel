...
use Arunov\Shoppingcart\Contracts\Buyable;
use Arunov\Shoppingcart\Exceptions\UnknownModelException;
use Arunov\Shoppingcart\Exceptions\InvalidRowIDException;
use Arunov\Shoppingcart\Exceptions\CartAlreadyStoredException;
...
class Cart
{
     ...
     * Add an item to the cart.
     *
     * @param \Arunov\Shoppingcart\CartItem $item          Item to add to the Cart
     * @param bool                              $keepDiscount  Keep the discount rate of the Item
     * @param bool                              $keepTax       Keep the Tax rate of the Item
     * @param bool                              $dispatchEvent
     *
     * @return \Arunov\Shoppingcart\CartItem The CartItem
     */
