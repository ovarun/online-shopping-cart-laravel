...
namespace Arunov\Tests\Shoppingcart;

use Mockery;
use PHPUnit\Framework\Assert;
use Arunov\Shoppingcart\Cart;
use Orchestra\Testbench\TestCase;
use Illuminate\Auth\Events\Logout;
use Illuminate\Support\Collection;
use Arunov\Shoppingcart\CartItem;
use Illuminate\Support\Facades\Event;
use Illuminate\Session\SessionManager;
use Illuminate\Contracts\Auth\Authenticatable;
use Arunov\Shoppingcart\ShoppingcartServiceProvider;
use Arunov\Tests\Shoppingcart\Fixtures\ProductModel;
use Arunov\Tests\Shoppingcart\Fixtures\BuyableProduct;
...
class CartTest extends TestCase
{
    ...
    /**
     * @test
     * @expectedException \Arunov\Shoppingcart\Exceptions\InvalidRowIDException
     */
    ...
    /**
     * @test
     * @expectedException \Arunov\Shoppingcart\Exceptions\UnknownModelException
    ...
    public function it_can_store_the_cart_in_a_database()
    {
        ...
        $this->assertDatabaseHas('user_shopping_cart', ['identifier' => $identifier, 'instance' => 'default', 'content' => $serialized]);
    ...
    /**
     * @test
     * @expectedException \Arunov\Shoppingcart\Exceptions\CartAlreadyStoredException
    ...
    public function it_can_restore_a_cart_from_the_database()
    {
        ...
        $this->assertDatabaseMissing('user_shopping_cart', ['identifier' => $identifier, 'instance' => 'default']);
     ...
     *
     * @return \Arunov\Shoppingcart\Cart
     */
